<script>
    import { ref } from 'vue'
    import TitrePage from '../Titres/TitrePage.vue'
    import CasePage from '../InfoBulles/CasePage.vue'
...
<template>
    <div>
        ...
        <p>Bienvenue sur l'encyclopédie Harry Potter</p><br>
